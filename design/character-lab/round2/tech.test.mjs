// node design/character-lab/round2/tech.test.mjs <id> [id...] — headless-browser contract checks for round-2 techniques.
...
try {
  for (const id of ids) {
    ...
    await page.goto(`${url}round2/tech-test.html?id=${id}`);
