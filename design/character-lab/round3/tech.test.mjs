// node design/character-lab/round3/tech.test.mjs <id> [id...] — headless-browser contract checks for round-3 techniques.
...
try {
  for (const id of ids) {
    ...
    await page.goto(`${url}round3/tech-test.html?id=${id}`);
