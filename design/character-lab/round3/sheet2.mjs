// node design/character-lab/round3/sheet2.mjs <id> [...] [--reduced] [--tint=#7a4b2a] [--matrix] → round3/evidence/sheet-<id>.png
...
try {
  ...
  await page.goto(`${url}round3/sheet2.html?${qs}`);
  ...
  console.log(`wrote design/character-lab/round3/evidence/${name}`);
